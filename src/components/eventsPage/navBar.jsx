      ...
      <div className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-base sm:text-lg font-medium text-gray-500 text-pretty max-w-2xl mx-auto">
            Join exciting sports activities, meet new people, and stay active in your community.
          </p>
        </div>
        <div className="relative max-w-3xl mx-auto">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-teal-500 rounded-xl opacity-10 group-hover:opacity-20 transition-opacity duration-200"></div>
