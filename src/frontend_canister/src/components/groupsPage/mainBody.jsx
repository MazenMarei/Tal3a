...
const GroupsCard = () => {
  ...
  const { groups, loading, error } = context || {
    groups: [],
    loading: false,
    error: null,
  };

  console.log("GroupsCard render:", {
    context,
    groups,
    loading,
    error,
    isGroupsArray: Array.isArray(groups),
  });
  ...
  return (
    <div className="flex-col w-full bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <Link to="/createGroup">
                  <Button className="w-50 bg-gradient-to-r items-center my-4 from-green-600 to-green-500 hover:from-green-600 hover:to-green-500 text-white font-semibold py-3 px-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 group/btn cursor-pointer flex items-center justify-center gap-2 mx-auto">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start justify-between">
                        ...
                        <Badge
                          className={`${getSkillLevelColor(
                            group.skillLevel
                          )} font-medium text-xs px-3 py-1 border`}
                        >
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-sm text-slate-600">
                          ...
                          <span className="font-medium">
                            {group.sportType || "Unknown Sport"}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-slate-600">
                          <Clock className="h-4 w-4 text-emerald-500" />
                          <span className="font-medium">
                            {group.nextEvent || "No event scheduled"}
                          </span>
                        </div>
                      </div>
                      <Link to={`/groups/${group.id || index}/posts`}>
                        <Button className="w-full cursor-pointer bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 group/btn">
      ...
      <Link to="/login">
        <Button className="w-full md:w-100 bg-gradient-to-r my-4 from-green-600 to-green-500 hover:from-green-600 hover:to-green-500 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 group/btn cursor-pointer flex items-center justify-center gap-2 mx-auto">
