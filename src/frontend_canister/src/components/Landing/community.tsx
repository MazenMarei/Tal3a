  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "Tal3a transformed how I find and join football matches. The community is amazing and everyone is welcoming! I've made so many new friends.",
      date: "2 days ago",
      sport: "Football",
      image:
    ...
    },
    {
      ...
      rating: 5,
      review:
        "As a coach, I love how easy it is to organize events and manage participants. The platform is intuitive and reliable with excellent features.",
      date: "1 week ago",
      sport: "Basketball",
      image:
    ...
    },
    {
      ...
      rating: 5,
      review:
        "The app helped me find the perfect yoga group. Now I have new friends and feel healthier than ever! Highly recommend to everyone.",
      date: "3 days ago",
      sport: "Yoga",
      image:
    ...
    },
    {
      ...
      rating: 5,
      review:
        "Swimming events are perfectly organized with professional instructors. The community support keeps me motivated every day!",
      date: "5 days ago",
      sport: "Swimming",
      image:
    ...
    },
    {
      ...
      rating: 5,
      review:
        "Tennis matches are so much fun! Great way to meet competitive players and improve my game with expert coaching tips.",
      date: "1 week ago",
      sport: "Tennis",
      image:
        "https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="text-center mb-20" variants={headerVariants}>
          ...
          >
            Join thousands of satisfied athletes across Egypt and experience the
            power of community-driven sports
          </motion.p>
        </motion.div>

        {/* Testimonials Carousel */}
        <motion.div className="relative mb-20" variants={sectionVariants}>
            ...
            {testimonials.map((_, index) => (
              <motion.button
                ...
                whileHover={{
                  scale: 1.3,
                  backgroundColor:
                    currentTestimonial === index ? "#22c55e" : "#f0fdf4",
                }}
                whileTap={{ scale: 0.9 }}
                animate={{
