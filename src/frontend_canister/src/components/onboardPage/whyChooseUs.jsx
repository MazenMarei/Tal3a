  ...
  const features = [
    {
      ...
      description: "Built on blockchain technology to manage events with transparency and high security.",
    ...
    },
    {
      ...
      description: "Connect with like-minded athletes and build lasting sports communities.",
    ...
    },
    {
      ...
      description: "Specially designed for Egyptian sports enthusiasts with full Arabic language support.",
      image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      icon: "",
      gradient: "from-emerald-50 via-emerald-100 to-green-50",
      accent: "emerald-500",
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            EXPERIENCE THE FUTURE OF SPORTS COMMUNITY MANAGEMENT WITH OUR INNOVATIVE PLATFORM
            DESIGNED FOR MODERN ATHLETES AND SPORTS.
          </motion.p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <motion.div 
                ...
                whileHover={{
                  boxShadow: "0 25px 50px -12px rgba(16, 185, 129, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.1)",
