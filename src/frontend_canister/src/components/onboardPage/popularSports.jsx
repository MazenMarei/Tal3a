  ...
  const sports = [
    {
      ...
      description: "Join the Egyptian running community and discover new routes throughout the country.",
    ...
    },
    {
      ...
      description: "Discover local gyms and participate in fitness challenges with professional trainers.",
    ...
    },
    {
      ...
      description: "Explore Egypt on two wheels with organized cycling groups and safe routes and exciting trails.",
