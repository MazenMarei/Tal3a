                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-700 text-sm font-medium">
                      {profileData.walletPrincipal.label}
                    </span>
                  </div>
                  <span className="font-semibold text-green-800">
                    {profileData.walletPrincipal.value}
                  </span>
                </div>
                <div className="mt-4">
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {profileData.freeDays.map((day, index) => (
              <div
                key={index}
                className="flex items-center p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200"
              >
