...
import { Route as authenticatedAdminRequestsRouteImport } from './routes/(authenticated)/admin-requests'
import { Route as authenticatedAdminManagementRouteImport } from './routes/(authenticated)/admin-management'
...
export interface FileRoutesById {
  ...
  '/login': typeof LoginRoute
  '/request-access': typeof RequestAccessRoute
  '/(authenticated)/admin-management': typeof authenticatedAdminManagementRoute
  '/(authenticated)/admin-requests': typeof authenticatedAdminRequestsRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/(authenticated)/admin-requests': {
      id: '/(authenticated)/admin-requests'
      path: '/admin-requests'
    ...
    '/(authenticated)/admin-management': {
      id: '/(authenticated)/admin-management'
      path: '/admin-management'
