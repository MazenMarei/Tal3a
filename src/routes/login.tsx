...
const LoginPage = () => {
  ...
  return (
    <>
      <Header></Header>
      <section className="bg-gradient-to-b from-primary to-secondary dark:to-gray-900 text-white relative overflow-hidden  font-cairo flex items-center min-h-[calc(100vh-5.5rem)] justify-center pt-20 lg:pt-0 mid:pt-0">
